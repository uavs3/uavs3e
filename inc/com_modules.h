...
int com_refm_get_active_ref(com_pic_manager_t *pm, com_pic_header_t *sh, com_ref_pic_t(*refp)[REFP_NUM]);
int com_refm_mark_ref_pic(com_pic_manager_t *pm, com_pic_header_t *sh);
