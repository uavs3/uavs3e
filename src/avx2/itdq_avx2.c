...
static void avs3_always_inline uavs3e_dct2_butterfly_h4_avx2(s16 *src, s16 *dst, int line, int shift, int bit_depth)
{
    __m128i s0, s1, s2, s3;
...
static void avs3_always_inline uavs3e_dct2_butterfly_h8_avx2(s16 *src, s16 *dst, int line, int shift, int bit_depth)
{
    if (line > 4) {
...
void uavs3e_dct2_butterfly_h16_avx2(s16 *src, s16 *dst, int line, int shift, int bit_depth)
{
    ...
    for (i = 0; i < line; i += 8) {
        in01 = _mm_load_si128((const __m128i *)&src[1 * line + i]);   // [17 16 15 14 13 12 11 10]
        in03 = _mm_load_si128((const __m128i *)&src[3 * line + i]);   // [37 36 35 34 33 32 31 30]
        in05 = _mm_load_si128((const __m128i *)&src[5 * line + i]);   // [57 56 55 54 53 52 51 50]
        in07 = _mm_load_si128((const __m128i *)&src[7 * line + i]);   // [77 76 75 74 73 72 71 70]
        in09 = _mm_load_si128((const __m128i *)&src[9 * line + i]);
        in11 = _mm_load_si128((const __m128i *)&src[11 * line + i]);
        in13 = _mm_load_si128((const __m128i *)&src[13 * line + i]);
        in15 = _mm_load_si128((const __m128i *)&src[15 * line + i]);
...
#undef COMPUTE_ROW
        ...
        in00 = _mm_load_si128((const __m128i *)&src[0 * line + i]);   // [07 06 05 04 03 02 01 00]
        in02 = _mm_load_si128((const __m128i *)&src[2 * line + i]);   // [27 26 25 24 23 22 21 20]
        in04 = _mm_load_si128((const __m128i *)&src[4 * line + i]);   // [47 46 45 44 43 42 41 40]
        in06 = _mm_load_si128((const __m128i *)&src[6 * line + i]);   // [67 66 65 64 63 62 61 60]
        in08 = _mm_load_si128((const __m128i *)&src[8 * line + i]);
        in10 = _mm_load_si128((const __m128i *)&src[10 * line + i]);
        in12 = _mm_load_si128((const __m128i *)&src[12 * line + i]);
        in14 = _mm_load_si128((const __m128i *)&src[14 * line + i]);
        ...
        EO0 = _mm256_add_epi32(_mm256_madd_epi16(T_00_04, c16_p38_p44), _mm256_madd_epi16(T_00_05, c16_p09_p25)); // EO0
        EO1 = _mm256_add_epi32(_mm256_madd_epi16(T_00_04, c16_n09_p38), _mm256_madd_epi16(T_00_05, c16_n25_n44)); // EO1
        EO2 = _mm256_add_epi32(_mm256_madd_epi16(T_00_04, c16_n44_p25), _mm256_madd_epi16(T_00_05, c16_p38_p09)); // EO2
        EO3 = _mm256_add_epi32(_mm256_madd_epi16(T_00_04, c16_n25_p09), _mm256_madd_epi16(T_00_05, c16_n44_p38)); // EO3

        EEO0 = _mm256_madd_epi16(T_00_06, c16_p17_p42);
        EEO1 = _mm256_madd_epi16(T_00_06, c16_n42_p17);

        EEE0 = _mm256_madd_epi16(T_00_07, c16_p32_p32);
        EEE1 = _mm256_madd_epi16(T_00_07, c16_n32_p32);
...
void uavs3e_dct2_butterfly_h32_avx2(s16 *src, s16 *dst, int line, int shift, int bit_depth)
{
    ...
    for (i = 0; i < line; i += 8) {
        in01 = _mm_load_si128((const __m128i *)&src[1 * line + i]);
        in03 = _mm_load_si128((const __m128i *)&src[3 * line + i]);
        in05 = _mm_load_si128((const __m128i *)&src[5 * line + i]);
        in07 = _mm_load_si128((const __m128i *)&src[7 * line + i]);
        in09 = _mm_load_si128((const __m128i *)&src[9 * line + i]);
        in11 = _mm_load_si128((const __m128i *)&src[11 * line + i]);
        in13 = _mm_load_si128((const __m128i *)&src[13 * line + i]);
        in15 = _mm_load_si128((const __m128i *)&src[15 * line + i]);
        in17 = _mm_load_si128((const __m128i *)&src[17 * line + i]);
        in19 = _mm_load_si128((const __m128i *)&src[19 * line + i]);
        in21 = _mm_load_si128((const __m128i *)&src[21 * line + i]);
        in23 = _mm_load_si128((const __m128i *)&src[23 * line + i]);
        in25 = _mm_load_si128((const __m128i *)&src[25 * line + i]);
        in27 = _mm_load_si128((const __m128i *)&src[27 * line + i]);
        in29 = _mm_load_si128((const __m128i *)&src[29 * line + i]);
        in31 = _mm_load_si128((const __m128i *)&src[31 * line + i]);
...
#undef COMPUTE_ROW
        ...
        in00 = _mm_load_si128((const __m128i *)&src[0 * line + i]);
        in02 = _mm_load_si128((const __m128i *)&src[2 * line + i]);
        in04 = _mm_load_si128((const __m128i *)&src[4 * line + i]);
        in06 = _mm_load_si128((const __m128i *)&src[6 * line + i]);
        in08 = _mm_load_si128((const __m128i *)&src[8 * line + i]);
        in10 = _mm_load_si128((const __m128i *)&src[10 * line + i]);
        in12 = _mm_load_si128((const __m128i *)&src[12 * line + i]);
        in14 = _mm_load_si128((const __m128i *)&src[14 * line + i]);
        in16 = _mm_load_si128((const __m128i *)&src[16 * line + i]);
        in18 = _mm_load_si128((const __m128i *)&src[18 * line + i]);
        in20 = _mm_load_si128((const __m128i *)&src[20 * line + i]);
        in22 = _mm_load_si128((const __m128i *)&src[22 * line + i]);
        in24 = _mm_load_si128((const __m128i *)&src[24 * line + i]);
        in26 = _mm_load_si128((const __m128i *)&src[26 * line + i]);
        in28 = _mm_load_si128((const __m128i *)&src[28 * line + i]);
        in30 = _mm_load_si128((const __m128i *)&src[30 * line + i]);
...
void uavs3e_dct2_butterfly_h64_avx2(s16 *src, int i_src, s16 *dst, int line, int shift, int bit_depth)
{
    // O[32] coeffs
    const __m256i c16_p45_p45 = _mm256_set1_epi32(0x002d002d);
    ...
    for (i = 0; i < line; i += 8) {
...

        {
            ...
            __m256i EO00, EO01, EO02, EO03, EO04, EO05, EO06, EO07, EO08, EO09, EO10, EO11, EO12, EO13, EO14, EO15;
            {
                __m256i T1, T2, T3, T4;
#define COMPUTE_ROW(r0103, r0507, r0911, r1315, r1719, r2123, r2527, r2931, c0103, c0507, c0911, c1315, c1719, c2123, c2527, c2931, row) \
    T1 = _mm256_add_epi32(_mm256_madd_epi16(r0103, c0103), _mm256_madd_epi16(r0507, c0507)); \
    T2 = _mm256_add_epi32(_mm256_madd_epi16(r0911, c0911), _mm256_madd_epi16(r1315, c1315)); \
    T3 = _mm256_add_epi32(_mm256_madd_epi16(r1719, c1719), _mm256_madd_epi16(r2123, c2123)); \
    T4 = _mm256_add_epi32(_mm256_madd_epi16(r2527, c2527), _mm256_madd_epi16(r2931, c2931)); \
...
void uavs3e_itrans_dct2_h4_w8_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ...
    uavs3e_dct2_butterfly_h4_avx2(src, tmp, 8, 5, MAX_TX_DYNAMIC_RANGE);
...
void uavs3e_itrans_dct2_h4_w16_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ...
    uavs3e_dct2_butterfly_h4_avx2(src, tmp, 16, 5, MAX_TX_DYNAMIC_RANGE);
...
void uavs3e_itrans_dct2_h4_w32_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ...
    uavs3e_dct2_butterfly_h4_avx2(src, tmp, 32, 5, MAX_TX_DYNAMIC_RANGE);
...
void uavs3e_itrans_dct2_h8_w4_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ...
    uavs3e_dct2_butterfly_h4_avx2(tmp, dst, 8, 20 - bit_depth, bit_depth);
}

void uavs3e_itrans_dct2_h8_w8_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ALIGNED_32(s16 tmp[8 * 8]);
    uavs3e_dct2_butterfly_h8_avx2(src, tmp, 8, 5, MAX_TX_DYNAMIC_RANGE);
    uavs3e_dct2_butterfly_h8_avx2(tmp, dst, 8, 20 - bit_depth, bit_depth);
}

void uavs3e_itrans_dct2_h8_w16_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ALIGNED_32(s16 tmp[8 * 16]);
    uavs3e_dct2_butterfly_h8_avx2(src, tmp, 16, 5, MAX_TX_DYNAMIC_RANGE);
    uavs3e_dct2_butterfly_h16_avx2(tmp, dst, 8, 20 - bit_depth, bit_depth);
}

void uavs3e_itrans_dct2_h8_w32_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ALIGNED_32(s16 tmp[8 * 32]);
    uavs3e_dct2_butterfly_h8_avx2(src, tmp, 32, 5, MAX_TX_DYNAMIC_RANGE);
    uavs3e_dct2_butterfly_h32_avx2(tmp, dst, 8, 20 - bit_depth, bit_depth);
}

void uavs3e_itrans_dct2_h8_w64_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ALIGNED_32(s16 tmp[8 * 64]);
    uavs3e_dct2_butterfly_h8_avx2(src, tmp, 64, 5, MAX_TX_DYNAMIC_RANGE);
    uavs3e_dct2_butterfly_h64_avx2(tmp, 8, dst, 8, 20 - bit_depth, bit_depth);
}
...
void uavs3e_itrans_dct2_h16_w4_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ...
    uavs3e_dct2_butterfly_h4_avx2(tmp, dst, 16, 20 - bit_depth, bit_depth);
}

void uavs3e_itrans_dct2_h16_w8_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ALIGNED_32(s16 tmp[16 * 8]);
    uavs3e_dct2_butterfly_h16_avx2(src, tmp, 8, 5, MAX_TX_DYNAMIC_RANGE);
    uavs3e_dct2_butterfly_h8_avx2(tmp, dst, 16, 20 - bit_depth, bit_depth);
}

void uavs3e_itrans_dct2_h16_w16_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ALIGNED_32(s16 tmp[16 * 16]);
    uavs3e_dct2_butterfly_h16_avx2(src, tmp, 16, 5, MAX_TX_DYNAMIC_RANGE);
    uavs3e_dct2_butterfly_h16_avx2(tmp, dst, 16, 20 - bit_depth, bit_depth);
}

void uavs3e_itrans_dct2_h16_w32_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ALIGNED_32(s16 tmp[16 * 32]);
    uavs3e_dct2_butterfly_h16_avx2(src, tmp, 32, 5, MAX_TX_DYNAMIC_RANGE);
    uavs3e_dct2_butterfly_h32_avx2(tmp, dst, 16, 20 - bit_depth, bit_depth);
}

void uavs3e_itrans_dct2_h16_w64_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ALIGNED_32(s16 tmp[16 * 64]);
    uavs3e_dct2_butterfly_h16_avx2(src, tmp, 64, 5, MAX_TX_DYNAMIC_RANGE);
    uavs3e_dct2_butterfly_h64_avx2(tmp, 16, dst, 16, 20 - bit_depth, bit_depth);
}
...
void uavs3e_itrans_dct2_h32_w4_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ...
    uavs3e_dct2_butterfly_h4_avx2(tmp, dst, 32, 20 - bit_depth, bit_depth);
}

void uavs3e_itrans_dct2_h32_w8_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ALIGNED_32(s16 tmp[32 * 8]);
    uavs3e_dct2_butterfly_h32_avx2(src, tmp, 8, 5, MAX_TX_DYNAMIC_RANGE);
    uavs3e_dct2_butterfly_h8_avx2(tmp, dst, 32, 20 - bit_depth, bit_depth);
}

void uavs3e_itrans_dct2_h32_w16_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ALIGNED_32(s16 tmp[32 * 16]);
    uavs3e_dct2_butterfly_h32_avx2(src, tmp, 16, 5, MAX_TX_DYNAMIC_RANGE);
    uavs3e_dct2_butterfly_h16_avx2(tmp, dst, 32, 20 - bit_depth, bit_depth);
}

void uavs3e_itrans_dct2_h32_w32_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ALIGNED_32(s16 tmp[32 * 32]);
    uavs3e_dct2_butterfly_h32_avx2(src, tmp, 32, 5, MAX_TX_DYNAMIC_RANGE);
    uavs3e_dct2_butterfly_h32_avx2(tmp, dst, 32, 20 - bit_depth, bit_depth);
}

void uavs3e_itrans_dct2_h32_w64_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ALIGNED_32(s16 tmp[32 * 64]);
    uavs3e_dct2_butterfly_h32_avx2(src, tmp, 64, 5, MAX_TX_DYNAMIC_RANGE);
    uavs3e_dct2_butterfly_h64_avx2(tmp, 32, dst, 32, 20 - bit_depth, bit_depth);
}

void uavs3e_itrans_dct2_h64_w8_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ALIGNED_32(s16 tmp[64 * 8]);
    uavs3e_dct2_butterfly_h64_avx2(src, 8, tmp, 8, 5, MAX_TX_DYNAMIC_RANGE);
    uavs3e_dct2_butterfly_h8_avx2(tmp, dst, 64, 20 - bit_depth, bit_depth);
}

void uavs3e_itrans_dct2_h64_w16_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ALIGNED_32(s16 tmp[64 * 16]);
    uavs3e_dct2_butterfly_h64_avx2(src, 16, tmp, 16, 5, MAX_TX_DYNAMIC_RANGE);
    uavs3e_dct2_butterfly_h16_avx2(tmp, dst, 64, 20 - bit_depth, bit_depth);
}

void uavs3e_itrans_dct2_h64_w32_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ALIGNED_32(s16 tmp[64 * 32]);
    uavs3e_dct2_butterfly_h64_avx2(src, 32, tmp, 32, 5, MAX_TX_DYNAMIC_RANGE);
    uavs3e_dct2_butterfly_h32_avx2(tmp, dst, 64, 20 - bit_depth, bit_depth);
}

void uavs3e_itrans_dct2_h64_w64_avx2(s16 *src, s16 *dst, int bit_depth)
{
    ALIGNED_32(s16 tmp[64 * 64]);
    uavs3e_dct2_butterfly_h64_avx2(src, 64, tmp, 32, 5, MAX_TX_DYNAMIC_RANGE);
    uavs3e_dct2_butterfly_h64_avx2(tmp, 64, dst, 64, 20 - bit_depth, bit_depth);
}
...
void uavs3e_dquant_avx2(s16 *src, s16 *dst, u8 *wq_matrix[2], int log2_w, int log2_h, int scale, int shift, int bit_depth)
{
    ...
    __m256i S1, D1;
    __m256i T1 = _mm256_set1_epi32(scale);
    __m256i T2 = _mm256_set1_epi32(offset);

    if ((log2_w + log2_h) & 1) {
        __m256i T3 = _mm256_set1_epi32(181);
        __m256i T4 = _mm256_set1_epi32(128);
        __m256i MIN = _mm256_set1_epi32(-32768);
        __m256i MAX = _mm256_set1_epi32(32767);
        ...
        for (int i = 0; i < size; i += 8) {
            ...
            D1 = _mm256_srai_epi32(D1, shift);
            D1 = _mm256_min_epi32(D1, MAX);
            D1 = _mm256_max_epi32(D1, MIN);
            D1 = _mm256_mullo_epi32(D1, T3);
            D1 = _mm256_add_epi32(D1, T4);
