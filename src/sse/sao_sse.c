                           ...
                           int smb_pix_width, int smb_available_left, int smb_available_right, int smb_available_up, int smb_available_down, int sample_bit_depth)
{
    ...
    case SAO_TYPE_EO_0: {
        ...
        mask = _mm_load_si128((__m128i *)(uavs3e_simd_mask[end_x - end_x_16 - 1]));
    ...
    case SAO_TYPE_EO_90: {
        ...
        __m128i t0, t1, t2, t3, t4, etype;
        __m128i c0, c1, c2, c3, c4;
        __m128i mask = _mm_loadu_si128((__m128i *)(uavs3e_simd_mask[(smb_pix_width & 15) - 1]));
    ...
    case SAO_TYPE_EO_135: {
        ...
        for (x = start_x_r0; x < end_x_r0; x += 16) {
            ...
            if (x != end_x_r0_16) {
                ...
                mask_r0 = _mm_load_si128((__m128i *)(uavs3e_simd_mask[end_x_r0 - end_x_r0_16 - 1]));
        ...
        mask_r = _mm_load_si128((__m128i *)(uavs3e_simd_mask[end_x_r - end_x_r_16 - 1]));
        //middle rows
        ...
        for (x = start_x_rn; x < end_x_rn; x += 16) {
            ...
            if (x != end_x_rn_16) {
                ...
                mask_rn = _mm_load_si128((__m128i *)(uavs3e_simd_mask[end_x_rn - end_x_rn_16 - 1]));
    ...
    case SAO_TYPE_BO: {
        ...
        __m128i mask = _mm_load_si128((const __m128i *)uavs3e_simd_mask[(smb_pix_width & 15) - 1]);
...
void uavs3e_sao_on_lcu_chroma_sse(pel *src, int i_src, pel *dst, int i_dst, com_sao_param_t *saoBlkParam, int smb_pix_height,
                                  int smb_pix_width, int smb_available_left, int smb_available_right, int smb_available_up, int smb_available_down, int sample_bit_depth)
{
    int type;
    int start_x, end_x, start_y, end_y;
    ...
    com_assert(saoBlkParam->modeIdc == SAO_MODE_NEW);
    type = saoBlkParam->typeIdc;
    ...
    case SAO_TYPE_EO_0: {
        ...
        mask = _mm_load_si128((__m128i *)(uavs3e_simd_mask[((end_x - end_x_16)>>1) - 1]));
    ...
    case SAO_TYPE_EO_90: {
        ...
        __m128i t0, t1, t2, t3, t4, etype;
        __m128i c0, c1, c2, c3, c4;
        __m128i mask = _mm_loadu_si128((__m128i *)(uavs3e_simd_mask[((smb_pix_width>>1) & 15) - 1]));
        __m128i mask1, mask2;
    ...
    case SAO_TYPE_EO_135: {
        ...
        for (x = start_x_r0; x < end_x_r0; x += 32) {
            ...
            if (x != end_x_r0_16) {
                ...
                mask_r0 = _mm_load_si128((__m128i *)(uavs3e_simd_mask[((end_x_r0 - end_x_r0_16)>>1) - 1]));
        ...
        mask_r = _mm_load_si128((__m128i *)(uavs3e_simd_mask[((end_x_r - end_x_r_16)>>1) - 1]));
        ...
        for (x = start_x_rn; x < end_x_rn; x += 32) {
            ...
            if (x != end_x_rn_16) {
                ...
                mask_rn = _mm_load_si128((__m128i *)(uavs3e_simd_mask[((end_x_rn - end_x_rn_16)>>1) - 1]));
    ...
    case SAO_TYPE_BO: {
        ...
        __m128i mask = _mm_load_si128((const __m128i *)uavs3e_simd_mask[((smb_pix_width>>1) & 15) - 1]);
        __m128i mask1, mask2;
        int end_x_16 = smb_pix_width - 31;
                           ...
                           int smb_pix_width, int smb_available_left, int smb_available_right, int smb_available_up, int smb_available_down, int sample_bit_depth)
{
    ...
    case SAO_TYPE_EO_0: {
        ...
        mask = _mm_load_si128((__m128i *)(uavs3e_simd_mask[end_x - end_x_8 - 1]));
        if (smb_pix_width == 4) {
    ...
    case SAO_TYPE_EO_135: {
        ...
        for (x = start_x_r0; x < end_x_r0; x += 8) {
            ...
            if (x != end_x_r0_8) {
                ...
                mask_r0 = _mm_load_si128((__m128i *)(uavs3e_simd_mask[end_x_r0 - end_x_r0_8 - 1]));
        ...
        mask_r = _mm_load_si128((__m128i *)(uavs3e_simd_mask[end_x_r - end_x_r_8 - 1]));
        //middle rows
        for (y = 1; y < smb_pix_height - 1; y++) {
        ...
        for (x = start_x_rn; x < end_x_rn; x += 8) {
            ...
            if (x != end_x_rn_8) {
                ...
                mask_rn = _mm_load_si128((__m128i *)(uavs3e_simd_mask[end_x_rn - end_x_rn_8 - 1]));
    ...
    case SAO_TYPE_BO: {
        ...
        if (smb_pix_width == 4) {
            ...
            mask = _mm_load_si128((const __m128i *)uavs3e_simd_mask[(smb_pix_width & 7) - 1]);
