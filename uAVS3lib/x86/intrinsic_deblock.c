...
void deblock_luma_ver_sse128(pel_t *src, int stride, int alpha, int beta)
{
    pel_t *p_src = src - 4;
...
void deblock_chroma_ver_sse128(pel_t *src_u, pel_t *src_v, int stride, int alpha_u, int beta_u, int alpha_v, int beta_v)
{
    __m128i UVL1, UVR1;
    __m128i TL0, TL1, TL2, TL3;
    __m128i TR0, TR1, TR2, TR3;
...
void deblock_luma_hor_sse128(pel_t *src, int stride, int alpha, int beta)
{
    int inc = stride;
    int inc2 = inc << 1;
    int inc3 = inc + inc2;
...
void deblock_chroma_hor_sse128(pel_t *src_u, pel_t *src_v, int stride, int alpha_u, int beta_u, int alpha_v, int beta_v)
{
    int inc = stride;
    int inc2 = inc << 1;
    int inc3 = inc + inc2;
    ...
    TL2 = _mm_set_epi32(0, 0, *(int*)(src_v - inc3), *(int*)(src_u - inc3));
    TL1 = _mm_set_epi32(0, 0, *(int*)(src_v - inc2), *(int*)(src_u - inc2));
    TL0 = _mm_set_epi32(0, 0, *(int*)(src_v - inc), *(int*)(src_u - inc));
    TR0 = _mm_set_epi32(0, 0, *(int*)(src_v), *(int*)(src_u));
    TR1 = _mm_set_epi32(0, 0, *(int*)(src_v + inc), *(int*)(src_u + inc));
    TR2 = _mm_set_epi32(0, 0, *(int*)(src_v + inc2), *(int*)(src_u + inc2));
    ...
    *(int*)(src_u - inc2) = _mm_extract_epi32(T0, 0);
    *(int*)(src_u - inc) = _mm_extract_epi32(T0, 2);
    *(int*)(src_u) = _mm_extract_epi32(T1, 0);
    *(int*)(src_u + inc) = _mm_extract_epi32(T1, 2);
    *(int*)(src_v - inc2) = _mm_extract_epi32(T0, 1);
    *(int*)(src_v - inc) = _mm_extract_epi32(T0, 3);
    *(int*)(src_v) = _mm_extract_epi32(T1, 1);
    *(int*)(src_v + inc) = _mm_extract_epi32(T1, 3);
}

void deblock_luma_ver_sse128_10bit(pel_t *src, int stride, int alpha, int beta)
{
    pel_t *p_src = src - 4;
    __m128i TL0, TL1, TL2, TL3;
    __m128i TR0, TR1, TR2, TR3;
...
void deblock_chroma_ver_sse128_10bit(pel_t *src_u, pel_t *src_v, int stride, int alpha_u, int beta_u, int alpha_v, int beta_v)
{
    __m128i UVL1, UVR1;
    __m128i TL0, TL1, TL2, TL3;
    __m128i TR0, TR1, TR2, TR3;
...
void deblock_luma_hor_sse128_10bit(pel_t *src, int stride, int alpha, int beta)
{
    int inc = stride;
    int inc2 = inc << 1;
    int inc3 = inc + inc2;
...
void deblock_chroma_hor_sse128_10bit(pel_t *src_u, pel_t *src_v, int stride, int alpha_u, int beta_u, int alpha_v, int beta_v)
{
    int inc = stride;
    int inc2 = inc << 1;
    int inc3 = inc + inc2;
